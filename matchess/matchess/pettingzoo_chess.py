...
#             # }
#             self.piece_images = {
#                 "pawn": [load_piece("BLACK_PAWN"), load_piece("WHITE_PAWN")],
#                 "knight": [load_piece("BLACK_KNIGHT"), load_piece("WHITE_KNIGHT")],
#                 "bishop": [load_piece("BLACK_BISHOP"), load_piece("WHITE_BISHOP")],
#                 "rook": [load_piece("BLACK_ROOK"), load_piece("WHITE_ROOK")],
#                 "queen": [load_piece("BLACK_QUEEN"), load_piece("WHITE_QUEEN")],
#                 "king": [load_piece("BLACK_KING"), load_piece("WHITE_KING")],
#             }
