...
if __name__ == '__main__':
    ...
    # # puzzle_dataset_filenames = ["puzzles_checkmate_in_2_elo_range_0_400", "puzzles_checkmate_in_2_elo_range_401_500", "puzzles_checkmate_in_2_elo_range_501_600", "puzzles_checkmate_in_2_elo_range_601_700"] #["puzzles_checkmate_in_2_elo_range_601_700"]
    # puzzle_dataset_filenames = ["puzzles_checkmate_in_2_elo_range_601_700"] #["puzzles_checkmate_in_2_elo_range_0_400", "puzzles_checkmate_in_2_elo_range_401_500", "puzzles_checkmate_in_2_elo_range_501_600", "puzzles_checkmate_in_2_elo_range_601_700"]
    ...
    last_completed_test_dataset_idx = 6

    # puzzle_dataset_filenames = ["puzzles_checkmate_in_2_elo_range_1501_1550", "puzzles_checkmate_in_2_elo_range_2001_3000"]
    # puzzle_dataset_checkmate_attribute = [2, 2, 2, 2]
    ...
    for dataset_idx, puzzle_dataset_filename in enumerate(puzzle_dataset_filenames):
        ...
        for puzzle_idx, puzzle_data in tqdm(enumerate(rows)):
            ...
            completed_process = subprocess.run(["./src/matchessbot/scripts/run_matchess_puzzles_sil_model.sh" , str(puzzle_idx), puzzle_dataset_filename + ".csv", test_result_dir_name])
