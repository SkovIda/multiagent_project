...
CFG_HOMOGENEOUS_MAS_INFERENCE = {
    ...
    "RUN_NUMBER": 2,
    "CHECKPOINT_FOLDER": "training_runs/MATChessFormer-Homogeneous-20/model_checkpoints/run_1/",
    "DATA_FOLDER": "dataset/gen_dataset_test.json",
    "LOGS_FOLDER": "training_runs/MATChessFormer-Homogeneous-20/logs/run_1",
    ...
    "PRINT_FREQUENCY": None,# print status once every so many steps
    "N_STEPS": None,      # number of training steps
    ...
    "BATCHES_PER_STEP": (16), #(64), #(16),# perform a training step, i.e. update parameters, once every so many batches
    ...
    "SAVE_CHECKPOINT_EPOCH_FEQUENCY": 10,
    # "MODEL_CHECKPOINT_FOLDER": "training_runs/" + model_config_name + "/model_epoch_checkpoints/"
    "MAX_DATASET_SIZE": None,
    "MODEL_TYPE": "MABC",
    "LOAD_MODEL_CHECKPOINT": "checkpoint_epoch_75_MATChessFormer-Homogeneous-20.pt"
    }


CFG_HETEROGENEOUS_MAS_INFERENCE = {
    ...
    #"DATA_FOLDER": "dataset/gen_dataset_test.json",
    #"LOGS_FOLDER": "training_runs/MATChessFormer-Heterogeneous-20/logs/run_2",
...
def import_config(model_config_name: str="MATChessFormer-20", run_number: int=0, inference=False):
    ...
    elif model_config_name=="MATChessFormer-Heterogeneous-20-hubersum":
        return {
            "NAME": model_config_name,
            "VOCAB_SIZES": get_vocab_sizes(),
            "D_MODEL": 512,
    ...
    elif model_config_name=="MATChessFormer-Heterogeneous-20-inference":
        return {
            "NAME": model_config_name,
            "VOCAB_SIZES": get_vocab_sizes(),
            "D_MODEL": 512,
